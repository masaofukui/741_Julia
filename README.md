...
* Topic 6: Firm Dynamics in a Frictional Labor Market (McCrary, 2024)
  * [Toplevel_Hopenhayn_Rogerson_Search.jl](Topic6/Toplevel_Hopenhayn_Rogerson_Search.jl): Top-level code solve Hopenhyan-Rogerson model with search frictions. The code works under the calibrated parameter values. Counterfactual analysis is work in progress.
